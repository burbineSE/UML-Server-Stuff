...
<div id="main">
            <div class="container">
                <h1 class="hometitle">Welcome to NC BookStack</h1>
            </div>
            <div class="container">
                <p class="homepara">NC BookStack is used book trading application for UMass Lowell North Campus students. Through this application you will be able to buy, sell and trade used books with other students on North Campus. To get started open to the menu at the top and register an account.</p>
            </div>
        </div>
    </body>
</html>
