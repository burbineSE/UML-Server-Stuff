<!DOCTYPE html>
<!--
    File: http://weblab.cs.uml.edu/~cburbine/A7_GrphCalc_Canvas.html
    ...
    Re-Created on November 20 at 5:07 PM due to unknown error
    Re-re-created on December 5 at 9:52 AM to better work with Assignemt 8
...
<html>
    ...
    <body>
        ...
        <p>Please enter the curve that you would like to plot.</p>
        <form name="frm" id="frm" method="GET">
            <label class="curveLabel">Curve:</label><input id="inputField"><br>
        </form>
