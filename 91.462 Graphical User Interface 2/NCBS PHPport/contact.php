...
<html>
  ...
  <!--
      File: http://weblab.cs.uml.edu/~cburbine/A3_index_Contact.html
      ...
      Created on September 21, 2013 at 2:30 PM

      This file is a list of my contact information. Will be updated as the semester goes on.  
...
<!--
	...
	<ul>
	  ...
	  At the moment the only contact information listed is my email address. At the moment I am unsure 
	  what else to add that is not to personal. I will add more info when I think of it.
	-->
	  <?php include 'menu.php'; ?> 
	  <!--<h2>Where You Can Find Me</h2>-->
	  <br><br><p><strong>Email:</strong> Christopher_Burbine@student.uml.edu</p>
      
	  <p><em>More info to come in the future!</em></p>
    </div>
  </body>
</html>
